...
class HigherLowerActivity : AppCompatActivity() {
    ...
    private fun updateUI() {
        ...
        // QUESTION: what is the purpose of "tv" before lastThrow?
        // ANSWER: this has nothing to do with the binding,
        // this is supposed to be the id of the textView
        ...
        when (currentThrow) {
            ...
            // QUESTION: why is the 6th case placed in an else statement in the Github answer?
        }
    }

    /**
     * Replaces the previous dice with the current one and replaces the current dice with a new dice
    ...
    private fun onAnswerCorrect() {
        ...
        //QUESTION: When should I pick LENGTH_LONG or LENGTH_SHORT?
    }
